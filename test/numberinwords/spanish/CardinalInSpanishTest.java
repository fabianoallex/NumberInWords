...
class CardinalInSpanishTest {
    ...
    @Test
    @DisplayName("inWords (Apocope)")
    void inWordsWithApocope() {
        Map<Long, String> testCases = new HashMap<>();
        testCases.put(1L, "un");
        testCases.put(-1L, "menos un");
        testCases.put(11L, "once");
        testCases.put(20L, "veinte");
        testCases.put(21L, "veintiún");
        testCases.put(101L, "ciento un");
        testCases.put(221L, "doscientos veintiún");

        CardinalInWords cardinalNumber = new CardinalInSpanish.Builder()
                .withApocope()
                .build();
    ...
    @Test
    @DisplayName("inWords (Female / Apocope)")
    void inWordsFemaleWithApocope() {
        Map<Long, String> testCases = new HashMap<>();
        testCases.put(1L, "una");
        testCases.put(-1L, "menos una");
        testCases.put(11L, "once");
        testCases.put(20L, "veinte");
        testCases.put(21L, "veintiuna");
        testCases.put(101L, "ciento una");
        testCases.put(221L, "doscientos veintiuna");
