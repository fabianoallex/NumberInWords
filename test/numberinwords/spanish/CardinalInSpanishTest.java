...
class CardinalInSpanishTest {
    ...
    void inWords() {
        ...
        testCases.put(1017L, "mil diecisiete");
        testCases.put(2099L, "dos mil noventa y nueve");
        testCases.put(7099L, "siete mil noventa y nueve");
        testCases.put(30000L, "treinta mil");
        testCases.put(80009L, "ochenta mil nueve");
